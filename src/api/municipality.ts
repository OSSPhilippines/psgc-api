 ...
 * !PATH: /municipality
 */
export const getAllMunicipalities = async (_: Request, res: Response) => {
 ...
 */
export const getAMunicipality = async (req: Request, res: Response) => {
 ...
 */
export const getAllBarangaysOfAMunicipality = async (
    req: Request,
    res: Response
) => {
    const { code } = req.params;
