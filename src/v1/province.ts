 ...
 * !PATH: /province/:code
 */
export const getAProvince = async (req: Request, res: Response) => {
 ...
 */
export const getAllCitiesOfAProvince = async (req: Request, res: Response) => {
    const { code } = req.params;
 ...
 */
export const getAllMunicipalitiesOfAProvince = async (
    req: Request,
    res: Response
) => {
    const { code } = req.params;
